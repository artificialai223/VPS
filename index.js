...
const getUserByPlatform = (user, platform = config.platforms[0]) => {
        return fetch(`https://api.fortnitetracker.com/v1/profile/${platform}/${user}`, {
            method: 'GET',
            headers: {
                'TRN-Api-Key': 296d3ab6-8259-4a3c-afeb-96a3c778a1c4
            },
        })
        .then(res => res)
        .catch(error => false)
...
function setStats(msg) {
    const embed = new Discord.RichEmbed()
        .setTitle("Managing 1000 Servers")
        .setAuthor("Stormer#5620")
        /*
...
client.login("NTQwODk5MDAzNjkzNDAwMDY0.XKI_pw.ixDuRXvLx0sDCi3ZlLxiySwngCE")
